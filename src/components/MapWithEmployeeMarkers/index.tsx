    ...
    <>
      ...
      >
        <div className="relative">
          {loading && (
            <div className="absolute inset-0 flex items-center justify-center bg-white bg-opacity-50 backdrop-blur-sm z-10 w-[600px] max-md:w-[400px] max-sm:w-[320px] aspect-square border">
              <Spinner />
            </div>
          )}
          <MapContainer
            ...
            className="w-[600px] max-md:w-[400px] max-sm:w-[320px] aspect-square"
          >
            <TileLayer
